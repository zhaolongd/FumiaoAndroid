...
public class WeekBillReportBean {
    ...
    public static class ComparedSumBean extends CoreBean {
        private String week_month; //week_month
        private String week;
        private float pay_amount_sum;
        ...
        public void setWeek_month(String week_month) {
    ...
    public static class TrendSumBean extends CoreBean {
        ...
        public String getZh_week_day() {
            return zh_week_day;
        }

        public void setZh_week_day(String zh_week_day) {
            this.zh_week_day = zh_week_day;
        }
