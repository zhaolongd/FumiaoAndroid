...
import com.fumiao.pay.manager.BannerLayoutManager;
import com.fumiao.pay.manager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(getResources().getColor(R.color.banner_indicator_selected));
            selectedGradientDrawable.setSize(dp2px(10), dp2px(5));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(getResources().getColor(R.color.banner_indicator_unselected));
